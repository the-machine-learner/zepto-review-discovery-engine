...
def render_screen_1(data) -> None:
    ...
    with left:
        render_html(f'<div style="min-height:68px;display:flex;flex-direction:column;justify-content:flex-start;">'
                    f'<div class="rd-section-title" style="font-size:1.05rem;">Segmentation by Shopping Habits</div>'
    ...
    with right:
        render_html(f'<div style="min-height:68px;display:flex;flex-direction:column;justify-content:flex-start;">'
                    f'<div class="rd-section-title" style="font-size:1.05rem;">Sub-segmentation by hesitation root cause</div>'
